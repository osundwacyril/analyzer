...
if __name__ == '__main__':
    ...
    processor.export_clusters_to_csv("prospector_out/clustered_resumes.csv")
    processor.generate_cluster_summary("prospector_out/cluster_summary.txt")
    processor.plot_clusters(method='pca', filename="prospector_out/resume_clusters_pca.png")
    processor.plot_clusters(method='tsne', filename="prospector_out/resume_clusters_tsne.png")