...
if __name__ == '__main__':
    ...
    processor.export_clusters_to_csv(f"outreach/clustered_resumes_{timestamp}.csv")
    processor.generate_cluster_summary(f"outreach/cluster_summary_{timestamp}.txt")
    processor.plot_clusters(method='pca', filename=f"outreach/resume_clusters_pca_{timestamp}.png")
    processor.plot_clusters(method='tsne', filename=f"outreach/resume_clusters_tsne_{timestamp}.png")