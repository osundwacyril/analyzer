...
if __name__ == '__main__':
    ...
    if not os.path.exists('../cleaned'): # Changed to 'files/cleaned' to match typical structure
    ...
    processor.export_clusters_to_csv("content_out/clustered_resumes_{timestamp}.csv")
    processor.generate_cluster_summary("content_out/cluster_summary_{timestamp}.txt")
    processor.plot_clusters(method='pca', filename="content_out/resume_clusters_pca_{timestamp}.png")
    processor.plot_clusters(method='tsne', filename="content_out/resume_clusters_tsne_{timestamp}.png")